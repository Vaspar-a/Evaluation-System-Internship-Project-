...
class Tbody extends Component {
  constructor(props) {
    ...
    this.colLength = this.props.data[0] !== undefined ? this.props.data[0].length : 3;
  ...
  // For POST
  provideData() {
    let details = this.data.map((element, index) => {
      let obj = {
        _id: element[1],
        sname: element[2],
      }
